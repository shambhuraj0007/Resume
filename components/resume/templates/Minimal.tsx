            ...
            <div>
              {resumeData.customSections.map((custom, idx) => (
                <div key={idx} className="break-inside-avoid mb-4 last:mb-0">
                  <SectionHeader title={(custom as any).sectionTitle || (custom as any).title || 'Custom Section'} />
                  {renderInput({
                    ...
                    className: 'text-sm',
                    textColor: 'text-gray-600',
                    ariaLabel: `${((custom as any).sectionTitle || (custom as any).title || 'Custom Section')} content`,
                  })}
                </div>
              ))}
            </div>
